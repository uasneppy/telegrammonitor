...
Відповідай лише у форматі семи рядків (ніякого JSON):
Загроза: так/ні
...
Визначення стратегічної загрози:
Стратегічна загроза – це будь-яке використання або підготовка далекобійної/стратегічної авіації, ракетоносіїв крилатих ракет, шахедів, балістики, виходу флоту в море, масових пусків, підготовки носіїв, або будь-яка авіаційна чи морська активність, що може становити загрозу для більшості України або міста Києва.

Якщо є натяки на ТУ-95, ТУ-160, МІГ-31, Х-101, Х-555, пуск шахедів, калібр, іскандер, флот, ракетоносії, балістика, ОТРК, брянськ, курськ, вороніж, стратегічна авіація, крилаті ракети, кинджал – позначай "Стратегічна: так".

Якщо інформація про стратегічність незрозуміла або немає достатньо даних – позначай "Стратегічна: невідомо".

Локальні загрози (артилерія, FPV-дрони, тактичні удари по окремих областях) – позначай "Стратегічна: ні".`;
...
Відповідай строго в форматі 7 рядків як вказано вище.`;
